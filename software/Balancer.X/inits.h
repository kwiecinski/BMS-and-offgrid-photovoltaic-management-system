...
#define BALANCE_BATT_12V_ON   PORTBbits.RB4=1
#define BALANCE_BATT_12V_OFF  PORTBbits.RB4=0

#define BALANCE_BATT_24V_ON   PORTBbits.RB5=1
#define BALANCE_BATT_24V_OFF  PORTBbits.RB5=0
