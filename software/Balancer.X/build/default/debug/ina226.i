...
static const uint8_t INA226_SHUNT_VOLTAGE = 0x01;
static const uint8_t INA226_BUS_VOLTAGE = 0x02;
static const uint8_t INA226_POWER = 0x03;
static const uint8_t INA226_CURRENT = 0x04;
...
static const uint8_t INA226_MANUFACTURER_ID = 0xFE;
static const uint8_t INA226_DIE_ID = 0xFF;
...
const int cMaxSampleAvgTblIdx = 7;
const int cMaxConvTimeTblIdx = 7;
...
status AutoFox_INA226_Init(AutoFox_INA226* this, uint8_t aI2C_Address, uint16_t aShuntResistor_mOhms, uint32_t aMaxCurrent_Amps)
{
    ...
    do { status s = (AutoFox_INA226_CheckI2cAddress(aI2C_Address)); if (s != OK) { return s; } } while (0);
SendUART_debug('a');
...
status AutoFox_INA226_setupCalibration(AutoFox_INA226* this, uint16_t aShuntResistor_mOhms, uint32_t aMaxCurrent_Amps)
{
    ...
    uint32_t theCurrentLSB_uA = (aMaxCurrent_Amps * 1000000 + 32766) / 32767;




    uint32_t theCal = (5120000 + (aShuntResistor_mOhms * theCurrentLSB_uA) / 2) /
                      (aShuntResistor_mOhms * theCurrentLSB_uA);
...
{
 ; if(!this->mInitialized) return NOT_INITIALIZED;;
...
status AutoFox_INA226_ConfigureAlertPinTrigger(AutoFox_INA226* this, enum eAlertTrigger aAlertTrigger, int32_t aValue, _Bool aLatching)
{
 uint16_t theMaskEnableRegister;

 ; if(!this->mInitialized) return NOT_INITIALIZED;;
 do { status s = (AutoFox_INA226_ReadRegister(this,INA226_MASK_ENABLE, &theMaskEnableRegister)); if (s != OK) { return s; } } while (0);
...
# 340 "ina226.c"
 ...
 do { status s = (AutoFox_INA226_WriteRegister(this,INA226_ALERT_LIMIT, (int16_t)theAlertValue)); if (s != OK) { return s; } } while (0);
 ...
 *aAlertTriggerCause_p = Unknown;
 ...
 do { status s = (AutoFox_INA226_ReadRegister(this,INA226_MASK_ENABLE, &theTriggerCause)); if (s != OK) { return s; } } while (0);
...
void SendErrorStatus(status err)
{
    ...
    {
        case OK:
            errorMsg = (unsigned char*)"OK \r\n";
            break;
        case FAIL:
            errorMsg = (unsigned char*)"FAIL \r\n";
            break;
        case INA226_TI_ID_MISMATCH:
            errorMsg = (unsigned char*)"INA226_TI_ID_MISMATCH \r\n";
            break;
        case INA226_DIE_ID_MISMATCH:
            errorMsg = (unsigned char*)"INA226_DIE_ID_MISMATCH \r\n";
            break;
        case CONFIG_ERROR:
            errorMsg = (unsigned char*)"CONFIG_ERROR \r\n";
            break;
        case I2C_TRANSMISSION_ERROR:
            errorMsg = (unsigned char*)"I2C_TRANSMISSION_ERROR \r\n";
            break;
        case BAD_PARAMETER:
            errorMsg = (unsigned char*)"BAD_PARAMETER \r\n";
            break;
        case NOT_INITIALIZED:
            errorMsg = (unsigned char*)"NOT_INITIALIZED \r\n";
            break;
        case INVALID_I2C_ADDRESS:
            errorMsg = (unsigned char*)"INVALID_I2C_ADDRESS \r\n";
            break;
        default:
            errorMsg = (unsigned char*)"UNKNOWN_ERROR \r\n";
            break;
    }
